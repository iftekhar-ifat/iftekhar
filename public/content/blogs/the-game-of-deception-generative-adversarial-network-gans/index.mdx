...
for epoch in range(epochs):
    ...
    if epoch % 50 == 0:
        with torch.no_grad():
            ...
            generated_samples = generated_samples.view(
                generated_samples.size(0), 28, 28
            )
...
Full Source Code : [Link](https://github.com/Iftekhar-Ifat/generative-models/tree/main/generative-adversarial-network)