...
4. **Training and Sampling:**
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % 10 == 0:
            ...
            plt.show()
    ```
     **Sampling Function**: Generates images pixel-by-pixel in order.
...
<div align="center">
  <Figure alt="PixelCNNSample" src="/content/blogs/pixel-by-pixel-image-creation-understanding-pixelcnn/data/sample.png" width="500" height="500" />
</div>
