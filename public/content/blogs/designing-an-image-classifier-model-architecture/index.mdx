...
<Figure alt="CIFAR-10" src="/content/blogs/designing-an-image-classifier-model-architecture/data/CIFAR-10.png" width={600} />
</div>
...
<div className='flex justify-center'>
<Figure alt="epoch_train" src="/content/blogs/designing-an-image-classifier-model-architecture/data/epoch_train.png" />
</div>
...
- **Mean (Average):**
  $$\mu_B = \frac{10 + 20 + 30 + 40 + 50}{5} = 30$$
- **Variance (Spread of Values):**
$$\sigma_B^2 = \frac{(10-30)^2 + (20-30)^2 + (30-30)^2 + (40-30)^2 + (50-30)^2}{5} = 200$$
...
- **For 20:** $$\frac{20 - 30}{\sqrt{200}} = -0.71$$
- **For 30:** $$\frac{30 - 30}{\sqrt{200}} = 0$$
- **For 40:** $$\frac{40 - 30}{\sqrt{200}} = 0.71$$
- **For 50:** $$\frac{50 - 30}{\sqrt{200}} = 1.41$$
...
1. **Apply Linear Transformation:** $$z = Wx + b$$
