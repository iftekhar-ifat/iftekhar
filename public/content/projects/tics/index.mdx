---
title: "Tics — Text · Image · Context · Search"
description: "A local-first, privacy-focused desktop app for searching your personal image library using natural language, a reference image, or both combined. Everything runs on-device — no cloud, no telemetry."
thumbnail: "/content/projects/tics/data/thumbnail.png"
techstack:
  [
    { title: "Electron", icon: "electron" },
    { title: "Tanstack Router", icon: "tanstack" },
    { title: "Python", icon: "python" },
    { title: "CLIP", icon: "open-ai" },
    { title: "FAISS", icon: "meta" },
  ]
links:
  [
    { type: "github", url: "https://github.com/Iftekhar-Ifat/tics" },
  ]
order: 1
isPublished: true
---
