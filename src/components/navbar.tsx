...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-black/10 bg-background/95 backdrop-blur-sm supports-backdrop-filter:bg-background/60 dark:border-white/10">
      <MaxWidthWrapper>
